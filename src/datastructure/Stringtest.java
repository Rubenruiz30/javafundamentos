...
public class Stringtest {
	 ...
	 * @return String
	 */
	private static String sqlProcess(String[] parameters, String querysql) {
...
//			System.out.println("the current character is " + character);rtth
